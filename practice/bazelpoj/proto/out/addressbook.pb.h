...
class SearchRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SearchRequest) */ {
 ...
 private:
  ...
  ::google::protobuf::int32 results_per_page_;
  mutable int _cached_size_;
  friend struct ::protobuf_addressbook_2eproto::TableStruct;
  friend void ::protobuf_addressbook_2eproto::InitDefaultsSearchRequestImpl();
};
// ===================================================================
...
inline ::google::protobuf::int32 SearchRequest::results_per_page() const {
  // @@protoc_insertion_point(field_get:SearchRequest.results_per_page)
  return results_per_page_;
}
inline void SearchRequest::set_results_per_page(::google::protobuf::int32 value) {
