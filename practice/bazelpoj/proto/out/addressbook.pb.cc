...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_PROTOBUF_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(::SearchRequest, results_per_page_),
};
...
const int SearchRequest::kResultsPerPageFieldNumber;
#endif  // !defined(_MSC_VER) || _MSC_VER >= 1900

SearchRequest::SearchRequest()
  : ::google::protobuf::Message(), _internal_metadata_(NULL) {
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    ::protobuf_addressbook_2eproto::InitDefaultsSearchRequest();
  }
  SharedCtor();
...
void SearchRequest::SerializeWithCachedSizes(
  ...
  if (this->results_per_page() != 0) {
    ::google::protobuf::internal::WireFormatLite::WriteInt32(3, this->results_per_page(), output);
  }
...
::google::protobuf::uint8* SearchRequest::InternalSerializeWithCachedSizesToArray(
  ...
  // int32 results_per_page = 3;
  if (this->results_per_page() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::WriteInt32ToArray(3, this->results_per_page(), target);
  }
...
void SearchRequest::InternalSwap(SearchRequest* other) {
  ...
  swap(results_per_page_, other->results_per_page_);
